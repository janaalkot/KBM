...
import {
  ReviewSummaryCard,
} from '../components/lessons/ReviewSummaryCard';
  ...
  const handleSubmit = async (
    ...
    */
    ...
    if (
      ...
      setError(
        'Please select a department, function, and industry.'
      );
    ...
    try {
      ...
      /*
      |--------------------------------------------------------------------------
      | 1. Create Lesson in .NET / SQL Server
      |--------------------------------------------------------------------------
      */
      ...
      /*
      |--------------------------------------------------------------------------
      | 2. Index Lesson in Python RAG
      |--------------------------------------------------------------------------
      */

      try {

        await RagService.indexLesson(
          createdLesson,
          'new'
        );
        ...
        /*
        Important:
        The lesson was already successfully
        created in SQL Server.

        Therefore we don't tell the user
        that lesson creation failed.

        We only warn that RAG indexing
        failed.
        */

        setRagWarning(
          'Lesson was created successfully, but it could not be indexed in the RAG knowledge base. Make sure the Python RAG service is running.'
        );
    ...
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="mb-8">
        ...
        <p className="mt-2 text-sm text-slate-600 dark:text-slate-400">
          ...
          Document a lesson learned and make it available to the engineering team and knowledge base.
      ...
      {ragWarning && (
        ...
        <div className="mb-6 rounded-xl border border-amber-200 bg-amber-50 p-4 text-sm text-amber-800 dark:border-amber-900/40 dark:bg-amber-950/20 dark:text-amber-300">
          ...
          >
            ...
            <div className="flex items-center justify-between border-t border-slate-200 pt-6 dark:border-slate-800">
              ...
              <button
                ...
                className="rounded-xl bg-sky-600 px-5 py-2.5 text-xs font-semibold text-white transition hover:bg-sky-500 disabled:cursor-not-allowed disabled:opacity-50"
              >
...
> = ({
  ...
  <div>
    ...
    <textarea
      ...
      rows={rows}
      required={required}
      className="w-full resize-y rounded-xl border border-slate-200 bg-slate-50 px-3.5 py-2.5 text-sm outline-none transition focus:border-sky-500 focus:ring-2 focus:ring-sky-500/20 dark:border-slate-700 dark:bg-[#07101a] dark:text-white"
    />
